...
st.set_page_config(page_title='Institution 2 Student Dashboard',layout='wide')

st.title('Institution 2 - Student Dashboard')
...
df_engagement_attendance = pd.read_csv('./student-data/institution-2-engagement-data.csv',parse_dates=['start_date','end_date'])
# df_test_scores = pd.read_csv('./student-data/institution-2-test-data.csv',parse_dates=['test_date'])
